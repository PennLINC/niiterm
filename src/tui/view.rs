...
fn render_help(frame: &mut Frame<'_>, area: Rect) {
    ...
    frame.render_widget(
        Paragraph::new(vec![
            ...
            Line::from("Tab: cycle active pane in triptych layout"),
            Line::from("H/L: previous/next volume"),
            Line::from("a: cycle axis (single) or active pane (triptych)"),
            ...
            Line::from("g: jump to middle slice or center all triptych panes"),
